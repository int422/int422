...
@font-face {
    ...
    src: url('C:/Users/Administrator/Desktop/int422/assets/Sixtyfour Convergence.ttf') format('truetype');
}
</style>

<pre style="text-align: left; font-family: 'Sixtyfour Convergence', sans-serif;">
💻 I'm a junior Python developer actively exploring the world of programming 
📖 Software architecture • Distributed systems
🎮 Music • Games • Anime • Rally • F1
🎧 Electro • lofi • 💘Egor Letov💘
</pre>
<br><br>
<br><br><br>
